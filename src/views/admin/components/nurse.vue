<template>
    <div>
		<e-table ref="nurseTable" :dataOrigin="dataOrigin" :tableCols="tableColList" :showOperation="true" :expand="true">
...
<script>
import { nurseTableURL, editNurse, addNurse, deleteNurse, allDepartment, allOffice } from '@/api/admin';
    ...
    methods: {
        ...
        handleDelete(row) {
            this.$confirm('确定要删除吗？', '提示', {
				...
				falg === 'confirm' && deleteNurse(row.nurseId).then(() => {
